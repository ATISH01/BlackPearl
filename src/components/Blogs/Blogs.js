...
const Blogs = () => {
    return (
        <div className='blogs'>
            ...
            <p><h5>Answer:</h5>Context api is method of send data Parents to desired child or sub child component.The other method of sending data component id props.It is the process that called props drilling.This method is so lenghty.To avoid this data passing system.Contex api is used in react.</p>
